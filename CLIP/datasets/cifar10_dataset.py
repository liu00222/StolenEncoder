...
def get_shadow_cifar10(args):
    ...
    # pretrained_transform = train_transform
    # finetune_transform = finetune_transform_cifar10
    ...
    #     pretrained_transform = None
    #     finetune_transform = finetune_transform_CLIP
    ...
    #print(f'train_transform is None: {train_transform is None}')
