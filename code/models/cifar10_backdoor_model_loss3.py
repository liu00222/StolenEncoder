...
class SimCLRBackdoorLoss3(nn.Module):
    def __init__(self, feature_dim=128, arch='resnet18'):
        super(SimCLRBackdoorLoss3, self).__init__()
    ...
    def forward(self, im_1, img_raw, img_backdoor, img_target,img_target_1, clean_net, args):
        ...
        loss_1 = - torch.sum(feature_backdoor * feature_target, dim=-1).mean()
        ...
        return loss, loss_1, loss_3, loss_4
